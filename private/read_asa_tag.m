function [val] = read_asa_tag(filename, elem, format, number)

% READ_ASA_TAG reads a specified element from an ASA file
%
% val = read_asa_tag(filename, element, type, number)
%
